export default function About() {
  return(
    <div id='about'>
      ...
      <p>
      In my free time I enjoy exploring the outdoors of British Columbia. I'm a climbing and mountaineering enthusiast and have travelled several places around the world for hiking trips 
      (Canada, Nepal, Thailand, Morocco, Mexico, USA and Brazil among others).
      </p>        
    </div>
  )
}